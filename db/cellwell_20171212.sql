...
--
-- Host: localhost    Database: cellwell
-- ------------------------------------------------------
...
CREATE TABLE `pictures` (
  ...
  `cellData_cellID` int(10) unsigned NOT NULL,
  PRIMARY KEY (`picture_ID`,`cellData_cellID`),
...
-- Dump completed on 2017-12-12 15:34:29
