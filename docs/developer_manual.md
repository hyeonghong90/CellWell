...
**cellwell_master.php file :** <br>
	...
	**index.html file:** <br>
		- Consits of HTML, JavaScript, and JQuery code implementing all of the quick access tabs to communicate with the database, query the necessary<br>
		  content, and post query results. <br>
	**get_images.php**: <br>
